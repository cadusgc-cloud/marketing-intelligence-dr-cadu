      ...
      <div className="mt-4 rounded-md bg-white/80 p-3 text-sm text-slate-700">
        <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <h4 className="mt-1 font-semibold text-slate-900">{handoff.focus.title}</h4>
            <p className="mt-1 text-xs leading-5 text-slate-600">{handoff.focus.detail}</p>
            <p className="mt-2 text-xs font-medium text-slate-500">Area sugerida: {handoff.focus.targetLabel}</p>
          </div>
          <a href={handoff.focus.targetHref} className="w-fit rounded-md bg-white px-3 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-100">
            Ir para foco
          </a>
        </div>
        <p className="mt-3 rounded-md bg-slate-50 p-2 text-xs leading-5 text-slate-600">{handoff.focus.action}</p>
      </div>
