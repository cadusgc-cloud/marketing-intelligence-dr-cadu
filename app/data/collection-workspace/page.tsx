    ...
    <div className="space-y-6">
      <section className="panel">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
          <div>
            <p className="text-xs font-semibold uppercase text-ocean">Checklist local v3.2</p>
            <h1 className="mt-1 text-3xl font-semibold tracking-normal text-ink">Workspace local de coleta</h1>
            <p className="mt-2 max-w-4xl text-sm leading-6 text-slate-600">
              Acompanhe o status da coleta semanal, o gate de decisao e o handoff pre-salvamento, sem banco, sem API e sem campos livres. Esta rota usa dados simulados como modelo; em `/data`, o workspace acompanha o plano calculado pelos campos atuais.
            </p>
      ...
      <WeeklyCollectionWorkspacePanel workspace={workspace} saveReadiness={saveReadiness} />
    </div>
  );
}
