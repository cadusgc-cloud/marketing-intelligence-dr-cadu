      ...
      <section className="grid gap-6 lg:grid-cols-3">
        <div className="panel lg:col-span-2">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <Link href="/stories/execution" className="inline-flex w-fit rounded-md border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50">
              Executar stories do dia
            </Link>
            <Link href="/stories/results" className="inline-flex w-fit rounded-md border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50">
              Registrar resultados dos stories
            </Link>
